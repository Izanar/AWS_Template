...
| Сценарий | Живой E2E |
|---|---|
| `ec2` | **Пройден** 2026-09-17 (см. docs/completion.md) |
| `local-wsl` | Не пройден — чек-лист ниже |
| `eks-fargate`, `eks-ec2-s3` | **Не запланирован** (решение владельца по стоимости); код — справочный |

## `ec2` — чек-лист живого прогона (уже выполнен; для повтора)
...
Живые прогоны `eks-fargate` и `eks-ec2-s3` не запланированы (стоимость control
plane и NAT). Код и README-описания сохранены как справочные; возобновление —
